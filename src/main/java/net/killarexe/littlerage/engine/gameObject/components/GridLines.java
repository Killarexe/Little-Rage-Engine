...
public class GridLines extends Component{
    ...
    public void update(float dt) {
        Vector2f cameraPos = Window.getScene().camera().postision;
        Vector2f projectonSize = Window.getScene().camera().getProjectionSize();
        ...
        int numVtLines = (int)(projectonSize.x / Settings.GRID_WIDTH) + 2;
        int numHzLines = (int)(projectonSize.y / Settings.GRID_HEIGHT) + 2;

        int height = (int)projectonSize.y + Settings.GRID_HEIGHT * 2;
        int width = (int)projectonSize.x + Settings.GRID_WIDTH * 2;
